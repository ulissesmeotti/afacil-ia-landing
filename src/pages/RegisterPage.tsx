    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary/5 via-background to-primary/5 p-4">
      <Card className="w-full max-w-md shadow-elegant backdrop-blur-sm bg-card/95 border-0">
        ...
        <CardContent className="px-8 pb-8">
          ...
          <form onSubmit={handleRegister} className="grid gap-6 mt-6">
            ...
            <div className="grid gap-3">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-11 px-4 pr-12 bg-background/50 border-border/50 focus:border-secondary/50 focus:bg-background transition-all"
                />
                <Button
                  type="button"
                  variant="ghost"
